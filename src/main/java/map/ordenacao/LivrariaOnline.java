...
public class LivrariaOnline {
    ...
    public Map<String, Livro> exibirLivrosPorAutor(){
        List <Map.Entry<String, Livro>> livrosPorAutor = new ArrayList<>(livroMap.entrySet());

        Collections.sort(livrosPorAutor, new ComparatorPorAutor());

        Map<String, Livro> livrosOrdenarAutor = new LinkedHashMap<>();

        for (Map.Entry<String,Livro> entry : livrosPorAutor) {
                livrosOrdenarAutor.put(entry.getKey(), entry.getValue());
            }
        return livrosOrdenarAutor;
    }

    public Map<String, Livro> pesquisarPorAutor(String autor){
        Map<String, Livro> livrosAutor = new LinkedHashMap<>();
        for (Map.Entry<String, Livro> entry : livroMap.entrySet()){
    ...
    public static void main(String[] args) {
        ...
        //String autorLivro = "George Orwell";
       // livrariaOnline.pesquisarPorAutor(autorLivro);
